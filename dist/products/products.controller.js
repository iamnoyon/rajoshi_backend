...
__decorate([
    ...
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all published products' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Toggle product active status (Admin)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Upload product images (Admin)' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Set primary image (Admin)' }),
    __param(0, (0, common_1.Param)('id')),
